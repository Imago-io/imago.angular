...
angular.module("imago").run(["$templateCache", function($templateCache) {$templateCache.put("/imago/imago-video.html","<div ng-class=\"[imagovideo.opts.align, imagovideo.opts.sizemode, imagovideo.mainSide, imagovideo.state]\" in-view=\"imagovideo.visible = $inview\" in-view-options=\"{debounce: 50}\" class=\"imago-video-content\"><div class=\"imago-video-wrapper\"><div ng-style=\"imagovideo.spacerStyle\" class=\"spacer\"></div><videogular vg-auto-play=\"::imagovideo.opts.autoplay\" vg-theme=\"::imagovideo.opts.theme\" ng-if=\"imagovideo.ready\" vg-update-state=\"imagovideo.state = $state\" vg-player-ready=\"imagovideo.onPlayerReady($API)\"><vg-media vg-src=\"::imagovideo.sources\" vg-loop=\"::imagovideo.opts.loop\" vg-preload=\"::imagovideo.opts.preload\"></vg-media><vg-controls ng-if=\"::imagovideo.opts.controls\" vg-autohide=\"true\" vg-autohide-time=\"1000\"><vg-play-pause-button></vg-play-pause-button><vg-time-display>{{ currentTime | date:\'mm:ss\' }}</vg-time-display><vg-scrub-bar><vg-scrub-bar-current-time></vg-scrub-bar-current-time></vg-scrub-bar><vg-time-display>{{ timeLeft | date:\'mm:ss\' }}</vg-time-display><vg-volume><vg-mute-button></vg-mute-button><vg-volume-bar></vg-volume-bar></vg-volume><vg-fullscreen-button></vg-fullscreen-button></vg-controls><vg-overlay-play></vg-overlay-play><vg-poster vg-url=\"::imagovideo.poster\"></vg-poster></videogular></div></div>");}]);